...
### 실시간 모니터링
![실시간 모니터링 - 전체 데이터 보기](Screenshots/screenshot_tab1_viewAll.png)
![실시간 모니터링 - 최근 30개 데이터 보기](Screenshots/screenshot_tab1_slidingWindow.png)

### 설비 상태
![설비 상태](Screenshots/screenshot_tab2.png)
